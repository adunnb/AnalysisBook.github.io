...
The power series [converges absolutely](../T/absolute-convergence) for all $x$ with $\lvert x - a \rvert < R$ and diverges for all $x$ with $\lvert x - a \rvert > R$. The set $(a - R, a + R)$ is called the **interval of convergence**.
